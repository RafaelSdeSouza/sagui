...
Sagui expects a numeric array with dimensions `[x, y, band]`, or a
FITS-like list with that array in `imDat`. Before segmentation, every
band should refer to the same sky footprint and effective angular
resolution.
