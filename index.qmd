...
<div class="hero-brand">
  <div class="hero-brand-copy">
    ...
    <div class="hero-actions"><a class="hero-button hero-button-primary" href="#installation">Install</a><a class="hero-button" href="#quick-start">Quick Start</a><a class="hero-button" href="https://github.com/RafaelSdeSouza/sagui">GitHub</a></div>
  </div>
  <div class="hero-brand-logos">
    <img class="hero-logo" src="images/sagui_upscaled.png" alt="sagui logo" />
    <div class="hero-affiliation"><img class="hero-note-logo" src="https://raw.githubusercontent.com/COINtoolbox/brand-assets/main/logo/COIN_2024_Logo.svg" alt="COIN logo" /><span>Part of the <strong>COIN Toolbox</strong></span></div>
  </div>
</div>
